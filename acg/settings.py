...
SECRET_KEY = '88vh2&n#n&ho!+i-2#ip&4*4a=(2if8rz+=+cut-ibd(3gnuuf'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'acg', 'static'),
)
SITE_ID = 1
...
DJANGOCMS_BOOTSTRAP4_TAG_CHOICES = ['div', 'section', 'article', 'header', 'footer', 'aside','small']
